                ...
                return new Promise(function (resolve, reject) {
                    setTimeout(function () {
                        ...
                        insertToDatabase().then((insert) => {
                            ...
                            tempData.PERSON_datepicker1=inPerson.datepicker1
                            tempData.PERSON_TYPEREQ=inPerson.typeReq
                            tempData.PERSON_TYPEUSER=inPerson.typeUser
                            tempData.PERSON_NAME=inPerson.name
                            tempData.PERSON_ID=inPerson.id
                            tempData.PERSON_AGE=inPerson.age
                            tempData.PERSON_NATIONALITY=inPerson.nationality
                            tempData.PERSON_RACE=inPerson.race
                            tempData.PERSON_PHONE=inPerson.phone
                            tempData.AID = {
                                'ADDRESS_HOME_ID':inAddress1.home_id,
                                'PROVINCE_NAME':inAddress1.province_name,
                                'AMPHUR_NAME':inAddress1.amphur_name,
                                'DISTRICT_NAME':inAddress1.district_name
                            }
                            tempData.AID2 = {
                                'WLOCATION':inAddress2.wLocation,
                                'WPLACEID':inAddress2.wPlaceId,
                                'PROVINCE_NAME':inAddress2.wProvince,
                                'AMPHUR_NAME':inAddress2.wDistrict,
                                'DISTRICT_NAME':inAddress2.wSubdistrict,
                                'WPHONE':inAddress2.wPhone,
                            }
                            tempData.FORM_BNO=inForm.bNo
                            tempData.FORM_BNUM=inForm.bNum
                            tempData.FORM_DATEPICKER2=inForm.datepicker2
                            tempData.FORM_BFEE=inForm.bFee
                            tempData.FORM_TYPEREFORM=inForm.typeReForm
                            tempData.FORM_TYPEPRODUCT=inForm.typeProduct
                            tempData.FORM_TIMESTART=inForm.timeStart
                            tempData.FORM_TIMEEND=inForm.timeEnd
                            tempData.FORM_DATEPICKER3=inForm.datepicker3
                            tempData.FORM_DATEPICKER4=inForm.datepicker4
                            tempData.FORM_DOCUMENTNAME=inForm.documentName
                            tempData.FORM_DOCUMENTNAME2=inForm.documentName2
