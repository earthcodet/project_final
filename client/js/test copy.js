...
function wdistrictSelect(amphurId) {
    ...
    for(let i = 0 ; i< district.length ; i++){
        if(district[i].AMPHUR_ID == amphurId && district[i].PROVINCE_ID == bProviceId){
...
function districtSelect(amphurId) {
    ...
    for(let i = 0 ; i< district.length ; i++){
        if(district[i].AMPHUR_ID == amphurId && district[i].PROVINCE_ID == tProviceId){
