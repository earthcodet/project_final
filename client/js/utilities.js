  ...
  for (var i = 0, f; (f = files[i]); i++) {
    ...
    reader.onload = (function(theFile) {
      return function(e) {
        ...
        span.innerHTML = [
          '<div class="column" style="width: 25%;height: 310px; "> <img width=100% height=270px class="thumb" src="',
          e.target.result,
          '" title="',
          escape(theFile.name),
          '"/>',
...
function deleteImage() {
  var index = Array.from(
    document.getElementById("outputImage").children
  ).indexOf(event.target.parentNode.parentNode);
  document
    .querySelector("#outputImage")
    .removeChild(document.querySelectorAll("#outputImage span")[index]);
